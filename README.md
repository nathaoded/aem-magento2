...
- Preview: https://main--aem-magento2--nathaoded.hlx.page/
- Live: https://main--aem-magento2--nathaoded.hlx.live/
...
1. Open the `aem-magento2` directory in your favorite IDE and start coding :)
